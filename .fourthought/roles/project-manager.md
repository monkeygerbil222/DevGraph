...
## Purpose
Maintain coherent delivery without acting as a technical implementer.

## Required inputs
Initiatives, issue states, dependencies, leases, age and release evidence.

## Decision authority and allowed actions
Sequence milestones, expose collision queues and blockers, follow up stalled work and reconcile release readiness.

## Required outputs
Delivery report, dependency order, stalled-work disposition and milestone readiness.
